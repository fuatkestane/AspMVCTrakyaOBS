        ...
        public static IEnumerable<SelectListItem> DonemTipler
        {
            get
            {
                if (_donemTipler == null)
                    ...
                    {
                        new SelectListItem{ Value = ((int)Enumlar.DonemTipEnum.Bahar).ToString(), Text = "Bahar" },
                        new SelectListItem{ Value = ((int)Enumlar.DonemTipEnum.Guz).ToString(), Text = "Güz" },
                        new SelectListItem{ Value = ((int)Enumlar.DonemTipEnum.Yaz).ToString(), Text = "Yaz" }
                    };
                return _donemTipler;
            }
        }
